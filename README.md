...
[![](https://img.shields.io/github/stars/AlexxIT/go2rtc?style=flat-square&logo=github)](https://github.com/dadav/go2rtc/stargazers)
...
[![](https://img.shields.io/github/downloads/AlexxIT/go2rtc/total?color=blue&style=flat-square&logo=github)](https://github.com/dadav/go2rtc/releases)
[![](https://goreportcard.com/badge/github.com/dadav/go2rtc)](https://goreportcard.com/report/github.com/dadav/go2rtc)
...
Download binary for your OS from [latest release](https://github.com/dadav/go2rtc/releases/):
...
- Binary: GitHub > [Actions](https://github.com/dadav/go2rtc/actions) > [Build and Push](https://github.com/dadav/go2rtc/actions/workflows/build.yml) > latest run > Artifacts section (you should be logged in to GitHub)
...
Configuration options and a complete list of settings can be found in [the wiki](https://github.com/dadav/go2rtc/wiki/Configuration).
...
- **Dahua Doorbell** users may want to change backchannel [audio codec](https://github.com/dadav/go2rtc/issues/52)
...
- **Ubiquiti UniFi** users may want to disable HTTPS verification. Use `rtspx://` prefix instead of `rtsps://`. And don't use `?enableSrtp` [suffix](https://github.com/dadav/go2rtc/issues/81)
...
_[New in v1.5.0](https://github.com/dadav/go2rtc/releases/tag/v1.5.0)_
...
All trascoding formats has [built-in templates](https://github.com/dadav/go2rtc/blob/master/internal/ffmpeg/ffmpeg.go): `h264`, `h265`, `opus`, `pcmu`, `pcmu/16000`, `pcmu/48000`, `pcma`, `pcma/16000`, `pcma/48000`, `aac`, `aac/16000`.
...
Read more about [hardware acceleration](https://github.com/dadav/go2rtc/wiki/Hardware-acceleration).
...
Exec source can run any external application and expect data from it. Two transports are supported - **pipe** (_from [v1.5.0](https://github.com/dadav/go2rtc/releases/tag/v1.5.0)_) and **RTSP**.
...
Check examples in [wiki](https://github.com/dadav/go2rtc/wiki/Source-Echo-examples).
...
_[New in v1.8.2](https://github.com/dadav/go2rtc/releases/tag/v1.8.2)_

Like `echo` source, but uses the built-in [expr](https://github.com/antonmedv/expr) expression language ([read more](https://github.com/dadav/go2rtc/blob/master/internal/expr/README.md)).
...
_[New in v1.6.1](https://github.com/dadav/go2rtc/releases/tag/v1.6.1)_
...
_[New in v1.2.0](https://github.com/dadav/go2rtc/releases/tag/v1.2.0)_
...
_[New in v1.7.0](https://github.com/dadav/go2rtc/releases/tag/v1.7.0)_
...
_[New in v1.8.3](https://github.com/dadav/go2rtc/releases/tag/v1.8.3)_

Support streaming from [GoPro](https://gopro.com/) cameras, connected via USB or Wi-Fi to Linux, Mac, Windows. [Read more](https://github.com/dadav/go2rtc/tree/master/internal/gopro).
...
**WebRTC Cameras** (_from [v1.6.0](https://github.com/dadav/go2rtc/releases/tag/v1.6.0)_)
...
_[New in v1.3.0](https://github.com/dadav/go2rtc/releases/tag/v1.3.0)_
...
_[New in v1.6.0](https://github.com/dadav/go2rtc/releases/tag/v1.6.0)_
...
**openipc** (_from [v1.7.0](https://github.com/dadav/go2rtc/releases/tag/v1.7.0)_)

Support connection to [OpenIPC](https://openipc.org/) cameras.

**wyze** (_from [v1.6.1](https://github.com/dadav/go2rtc/releases/tag/v1.6.1)_)
...
**kinesis** (_from [v1.6.1](https://github.com/dadav/go2rtc/releases/tag/v1.6.1)_)
...
_[New in v1.8.0](https://github.com/dadav/go2rtc/releases/tag/v1.8.0)_
...
[API description](https://github.com/dadav/go2rtc/tree/master/api).
...
2. Camera snapshots in MP4 format (single frame), can be sent to [Telegram](https://github.com/dadav/go2rtc/wiki/Snapshot-to-Telegram)
...
_[New in v1.1.0](https://github.com/dadav/go2rtc/releases/tag/v1.1.0)_
...
- JPEG snapshots: `http://192.168.1.123:1984/api/frame.jpeg?src=camera1`
  ...
  - You can use `hardware`/`hw` param [read more](https://github.com/dadav/go2rtc/wiki/Hardware-acceleration)
...
There are no plans to embed complex transcoding algorithms inside go2rtc. [FFmpeg source](#source-ffmpeg) does a great job with this. Including [hardware acceleration](https://github.com/dadav/go2rtc/wiki/Hardware-acceleration) support.
...
[read more](https://github.com/dadav/go2rtc/wiki/Snapshot-to-Telegram)
...
At this moment I am focused on improving stability and adding new features to **go2rtc**. Maybe someone could write such a card themselves. It's not difficult, I have [some sketches](https://github.com/dadav/go2rtc/blob/master/www/webrtc.html).
